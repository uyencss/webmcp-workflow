...
- Documented the `batch.actionTimeoutMs` option in the workflow creator skill so
  agents know each batch sub-action can fail independently instead of stalling
  the whole batch.
